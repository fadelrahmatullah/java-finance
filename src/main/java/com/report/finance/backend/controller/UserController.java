...
public class UserController extends BaseController{
	...
	@GetMapping("get-user")
	public Response<UserInfoEntity> getUser(Authentication authentication){

		UserInfoEntity response = userService.getUserInfo(this.getLoginUsername(authentication));

		log.info("rsult get user {}",response);
